 ...
 * Each enum constant represents a specific type of physiologicalError.
 *
 ...
 * - DATABASE_ERROR: An physiologicalError occurred while interacting with the database.
 * - AUTHENTICATION_ERROR: An physiologicalError occurred during the authentication process.
 */
